...
class AppTheme {
  ...
  static ThemeData get darkTheme {
    ...
    Color secondaryTextColor = const Color(0xFFD9D9D9).withOpacity(0.6);

    return ThemeData(
      brightness: Brightness.dark,
      fontFamily: GoogleFonts.poppins().fontFamily,
      scaffoldBackgroundColor: Pallete.black1,
      primaryColor: Pallete.primary,
      ...
      splashFactory: NoSplash.splashFactory, // Hilangkan ripple effect
    );
  }
